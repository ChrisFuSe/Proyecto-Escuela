...
<body>
    ...
    <label for="btm-menu" id="titulo" class="h1"><img id="icomenu" src="{{ asset('img/icono-menu.png') }}"
            alt="Menu">@yield('operacion')</label>
    ...
    <div hidden>Icons made by <a href="https://www.flaticon.com/authors/roundicons" title="Roundicons">Roundicons</a>
