    ...
    <div class="container" style="margin-top: 3%;">
        ...
        <div class="row">
            <div class="input-group input-group-lg mb-4">
                <label class="input-group-text" for="inputGroupSelect01">Consultar</label>
        ...
        <div class="row">
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" name="numero_control" placeholder="Número de control..."
...
<form action="{{route('consultar.datos',$pagos->num_referencia)}}" method="GET" accept-charset="utf-8">
    ...
    <div class="row">
        ...
        <div class="form-floating">
            <textarea class="form-control" name="descripcion" placeholder="Leave a comment here"
                id="floatingTextarea">{{$datos->descripcion}}</textarea>
