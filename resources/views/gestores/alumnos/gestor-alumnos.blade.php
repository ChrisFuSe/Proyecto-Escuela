...
<div class="container-fluid" style="margin-top: 5%;">
    <div class="row row-cols-3 justify-content-center">
        ...
        <div class="col">
            <a href="alumnos/consultar-eliminar"><img src="../img/Iconos Gestor Alumnos/Estudiante-Consultar.png" class="botones-navegacion" alt="Responsive image" width="50%"></a>
            <p>Consultar y Eliminar alumnos</p>
        </div>
    </div>
</div>
@endsection