            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre usuario..."
                        aria-label="Nombre de usuario" maxlength="100" name="username" required>
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nombres..." aria-label="Nombres"
                        name="nombres" maxlength="100" required>
            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Primer Apellido..."
                        aria-label="Apellido Paterno" maxlength="50" name="ap_paterno" required>
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Segundo Apellido..."
                        aria-label="Apellido Materno" maxlength="50" name="ap_materno" required>
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
