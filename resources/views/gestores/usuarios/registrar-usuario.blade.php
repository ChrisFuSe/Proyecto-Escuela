        ...
        <div class="row row-cols-2">
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Nombre usuario..." aria-label="Nombre de usuario" name="username">
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="@ejemplo.com" aria-label="Correo electronico" name="email">
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Contraseña..." aria-label="Contrasenia" name="password">
                </div>
            </div>
            <div class="col">
                <div class="input-group input-group-lg mb-4">
            ...
            <div class="col">
                <div class="input-group input-group-lg mb-4">
                    ...
                    <input type="text" class="form-control" placeholder="Repita contraseña..." aria-label="Repita contraseña" name="password">
                </div>
            </div>
            <div class="col">
            <div class="input-group input-group-lg mb-4">
