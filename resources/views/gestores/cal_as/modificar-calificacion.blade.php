    ...
    <div class="row row-cols-2">
        ...
        <div class="col">
            ...
            <span class="input-group-text">Calificación oral:</span>
                <input type="number" min="0" max="100" class="form-control" id="calificacion_oral" name="calificacion_oral" value="{{$cal->calificacion_oral}}" required>
            </div>
        </div>
        <div class="col">
            <div class="input-group input-group-lg mb-4">
            <span class="input-group-text">Calificación escrita:</span>
                <input type="number" min="0" max="100" class="form-control" id="calificación_escrita" name="calificacion_escrita" value="{{$cal->calificacion_escrita}}" required>
            </div>
        </div>
        <div class="col">
            <div class="input-group input-group-lg mb-4">
            <span class="input-group-text">Asistencia total:</span>
                <input type="number" min="0" max="100" class="form-control" id="asistencia_total" name="asistencia_total" value="{{$cal->asistencia_total}}" required>
            </div>
        </div>       
</div>
