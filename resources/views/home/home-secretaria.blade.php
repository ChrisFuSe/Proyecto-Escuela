...
@section('logout')
<a style="margin-left: 90%; display: inline;" href="{{route('login.salir')}}"><img style="position: absolute; margin-top:-3%;" width="4%" class="botones-navegacion" src="{{secure_asset('img/cerrar-sesion.png')}}"></a>
@endsection
